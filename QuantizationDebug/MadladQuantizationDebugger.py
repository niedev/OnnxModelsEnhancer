...
def show_quant_error_weight(model_path: str, model_qdq_quantized_path: str, encoder = True, qdq=True, save_result_folder=None):
    ...
    if(qdq):
        qdq_weight_cmp = qdq_loss_debug_updated.create_weight_matching(model_path, model_qdq_quantized_path)
    else:
        qdq_weight_cmp = qdq_loss_debug_updated.create_weight_matching_qoperator(model_path, model_qdq_quantized_path)
